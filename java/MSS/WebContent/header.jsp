...
<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="home.jsp">GÜNER MOBİLYA</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="home.jsp">Anasayfa</a></li>
            ...
            <div class="navbar-text pull-right">
				...
				<c:if test="${empty kullaniciAdi }">
				   <a href="login.jsp" class="navbar-link">Üye Girişi</a>
				</c:if>
				
				<c:if test="${not empty kullaniciAdi }">
				   <span> Hoşgeldiniz &nbsp;${kullaniciAdi} </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				   <a href="uyecikis" class="navbar-link">Çıkış</a>
				</c:if>
				/ <a href="kayitol.jsp" class="navbar-link">Yeni Üyelik</a>
				</div>
			</div>
          </div><!--/.nav-collapse -->
        </div>
